...
SHORT_DESCRIPTION = 'Tabular and time-sequence data in Python'
# CHANGE THIS
...
project = u' ZqTable'
copyright = u'2014, %s' % PROJECT_AUTHORS
...
man_pages = [
    ('index', 'zqtable', u' ZqTable Documentation', [u'xxx'], 1)
]
...
texinfo_documents = [
    ('index', 'ZqTable', u'ZqTable Documentation',
     u'xxx', 'ZqTable', 'One line description of project.',
     'Miscellaneous'),
]
